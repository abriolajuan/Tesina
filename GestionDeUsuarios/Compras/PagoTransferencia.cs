...
namespace GestionDeUsuarios
{
    public partial class PagoTransferencia : Form
    {
        ...
        private void PagoTransferencia_Load(object sender, EventArgs e)
        {
            cargarComboBox2();
            ocultarDetalles();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Aviso m = new Aviso();
                m.label1.Text = "Debe ingresar un n° de cuenta destino";
                m.ShowDialog();
            }
            else
            {
        ...
        private void guardarDetalleDeMedio()
        {
            ...
            conexion.Open();
            string sql = "insert into DETALLEDEMEDIO (MEDIO_TR_ID, DETMEDIO_APELLIDOTIT, DETMEDIO_NOMBRETIT, DETMEDIO_CUENTADEST, ENTIDAD_ID, PAGO_COMPRA_ID) values (@medio,@apellidotitular,@nombretitular,@cuentadest, @entidad, @pagocompra)";
            SqlCommand comando = new SqlCommand(sql, conexion);
            ...
            comando.Parameters.Add("@cuentadest", SqlDbType.VarChar).Value = textBox5.Text;
