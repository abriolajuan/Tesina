...
// CLASE MAESTRA QUE VA A MANDAR LOS MAIL A UNO O VARIOS DESTINARIOS
    ...
    public abstract class MasterMailServer
    {
        ...
        public void sendMail (string subject, string body, List<string> recipientMail)
        {
            ...
            try
            {
                ...
                mailMessage.Body = body; // MENSAJE DEL CORREO
                mailMessage.Priority = MailPriority.Normal; // PRIORIDAD DEL CORREO
